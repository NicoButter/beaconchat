...
class MorseEncoder {
    ...
    /** Convierte un texto a su representación en código Morse (string legible) */
        ...
        for (i in upperText.indices) {
            ...
            for (j in code.indices) {
                ...
                if (j < code.length - 1) {
                    ...
                    // Unless it's the very last character of the message, but adding a trailing
                    // silence is fine.
